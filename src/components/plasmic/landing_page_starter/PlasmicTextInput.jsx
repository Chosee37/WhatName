...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 8qHKVd8Do2XTma/css
import SearchIcon from "./icons/PlasmicIcon__Search"; // plasmic-import: ezhfOWcVI4wD2/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchIcon
                className={classNames(projectcss.all, sty.svg__aP8Sy)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <CheckIcon
                className={classNames(projectcss.all, sty.svg__jw1J)}
                role={"img"}
              />
            ),
