...
import sty from "./PlasmicValueProp.module.css"; // plasmic-import: pCj1UpAZoaMeJL/css
    ...
    () => [
      {
        ...
        initFunc: true ? ($props, $state, $ctx) => $props.flatIcon : undefined
      },
      {
        path: "vertical",
        type: "private",
        variableType: "variant",
        initFunc: true ? ($props, $state, $ctx) => $props.vertical : undefined
      },
      {
        path: "card",
        type: "private",
        variableType: "variant",
        initFunc: true ? ($props, $state, $ctx) => $props.card : undefined
      },
      {
        path: "noTitle",
        type: "private",
      ...
      },
      {
        ...
        variableType: "variant",
        initFunc: true
          ? ($props, $state, $ctx) => $props.darkBackground
          : undefined
      }
    ],
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__i6E2)}
              displayHeight={"56px"}
