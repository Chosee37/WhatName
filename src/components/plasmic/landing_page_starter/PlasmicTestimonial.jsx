...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: ZAPv9uZXsb-IqK/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__s7Aem)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__rx0R2)}
      >
        <p.PlasmicImg
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__wZj04)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__psuHt)}>
            {p.renderPlasmicSlot({
