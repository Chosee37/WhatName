...
import sty from "./PlasmicListItem.module.css"; // plasmic-import: xYz3o7XyodVA1_/css
    ...
    () => [
      {
        ...
        initFunc: true
          ? ($props, $state, $ctx) => $props.bottomBorder
          : undefined
      },
      {
        path: "leftCheck",
        type: "private",
        variableType: "variant",
        initFunc: true ? ($props, $state, $ctx) => $props.leftCheck : undefined
      }
    ],
  ...
  return (
    ...
    >
      ...
      {p.renderPlasmicSlot({
        defaultContents: (
          <CheckCircleIcon
            className={classNames(projectcss.all, sty.svg__uDe6E)}
            role={"img"}
          />
        ),
